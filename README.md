...
```shell
npm install grunt-postcss-multioutput --save-dev
```

Once the plugin has been installed, it may be enabled inside your Gruntfile with this line of JavaScript:

```js
grunt.loadNpmTasks('grunt-postcss-multioutput');
```

## Usage

```
$ npm install grunt-postcss-multioutput pixrem autoprefixer cssnano
```
...
#Added destFolder
Added destFolder to config the folder for the output of multiple files
